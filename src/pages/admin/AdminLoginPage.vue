...
import CusInput from '@/components/cus-ui/input/CusInput.vue';
import CusToggle from '@/components/cus-ui/toggle/CusToggle.vue';
...
<template>
  <align-center-layout class="admin-login-page">
    <div class="logo-text">MakkaPakka</div>
    <cus-card class="card">
      <h1>登录</h1>
